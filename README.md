...
~~I will be adding a button to delete the database soon...~~ SQLite3 doesn't have an option to delete the database via code. It stores it as a file on the computer. In order to delete you have to delete the file from your computer after closing the program. 
